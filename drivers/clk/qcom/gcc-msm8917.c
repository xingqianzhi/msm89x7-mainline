...
static const struct qcom_reset_map gcc_msm8940_resets[] = {
	[GCC_CAMSS_MICRO_BCR]		= { 0x56008 },
	[GCC_MSS_BCR]			= { 0x71000 },
	[GCC_QUSB2_PHY_BCR]		= { 0x4103c },
	[GCC_USB_HS_BCR]		= { 0x41000 },
...
static const struct regmap_config gcc_msm8940_regmap_config = {
	.reg_bits	= 32,
	.reg_stride	= 4,
	.val_bits	= 32,
	.max_register	= 0x80000,
...
static struct gdsc *gcc_msm8940_gdscs[] = {
	[CPP_GDSC] = &cpp_gdsc,
	[JPEG_GDSC] = &jpeg_gdsc,
	[MDSS_GDSC] = &mdss_gdsc,
	[OXILI_GX_GDSC] = &oxili_gx_gdsc,
...
static const struct qcom_cc_desc gcc_msm8937_desc = {
	.config = &gcc_msm8940_regmap_config,
	.clks = gcc_msm8940_clocks,
	.num_clks = ARRAY_SIZE(gcc_msm8940_clocks),
	.resets = gcc_msm8940_resets,
	.num_resets = ARRAY_SIZE(gcc_msm8940_resets),
	.gdscs = gcc_msm8940_gdscs,
	.num_gdscs = ARRAY_SIZE(gcc_msm8940_gdscs),
};
...
static int gcc_msm8917_probe(struct platform_device *pdev)
{
	...
	if (gcc_desc == &gcc_msm8937_desc)
		gcc_msm8940_desc.clks[GCC_IPA_TBU_CLK] = NULL;
...
MODULE_DESCRIPTION("Qualcomm GCC MSM8917/8937/8940 Driver");
MODULE_LICENSE("GPL");
